...
const CloudSolutions = ({ selectedLanguage }) => {
  const t = translations[selectedLanguage]?.cloudSolutions || translations.en.cloudSolutions;
      ...
      <main className="container py-5">
        <section className="services-section mb-5">
          ...
          <div className="row row-cols-1 row-cols-md-2 g-4">
            {t.whatWeOffer.map((service, index) => (
        ...
        <section className="testimonial-section">
          ...
          <div id="cloudSolutionsCarousel" className="carousel slide" data-bs-ride="carousel">
            ...
            <button className="carousel-control-prev" type="button" data-bs-target="#cloudSolutionsCarousel" data-bs-slide="prev" aria-label="Previous testimonial">
              <span className="carousel-control-prev-icon" aria-hidden="true"></span>
            </button>
            <button className="carousel-control-next" type="button" data-bs-target="#cloudSolutionsCarousel" data-bs-slide="next" aria-label="Next testimonial">
