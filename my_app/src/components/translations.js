const translations = {
  en: {
      ...
      items: [
        {
          ...
          description: 'Tailored advice to help Māori businesses leverage technology for growth.',
        },
        {
          title: 'Digital Education',
          description: 'Workshops and training to build tech skills in our communities.',
        },
        {
          title: 'IT Support',
        ...
        },
        {
          ...
          description: 'Protecting Māori data with modern cyber protection strategies.',
        },
        {
    ...
    techConsultationPage: {
      title: 'Technology Consultation',
      subtitle: 'Tailored tech advice to help your whānau or Māori business thrive in the digital world.',
      ...
      steps: [
        '📞 Book a free initial kōrero',
        '📝 Share your goals or digital challenges',
      ...
      testimonialQuote: '“WhānauTech helped us get our small kai business online. Now we’re reaching more people than ever!”',
      testimonialAuthor: '– Aroha, Kirikiriroa',
      servicesList: [
        '💡 Custom tech strategy sessions',
        '🌐 Website & digital presence guidance',
        '📱 App & software recommendations',
        '🔧 Systems setup and digital toolkits',
        '🧠 Upskilling & capability-building support',
      ]
    },
    itSupport: {
      title: "IT Support",
      subtitle: "Reliable and friendly IT support tailored to help Māori businesses and whānau keep their systems running smoothly.",
      subtitleMaori: "He tautoko hangarau pono, whakahoahoa hoki, kua whakaritea hei āwhina i ngā pakihi Māori me te whānau kia rere mārika ō rātou pūnaha.",
      ...
      whyTitle: "Why This Matters",
      whyText: "At WhānauTech, we believe technology should uplift and empower tangata whenua. Our IT support is personalized, responsive, and grounded in tikanga Māori, ensuring your systems are reliable so you can focus on your kaupapa.",
      howTitle: "How It Works",
      howSteps: [
      ...
      readyTitle: "Ready to Get Started?",
      readyText: "Contact our IT support team to keep your systems running smoothly and take the next step in your digital journey.",
      readyTextMi: "Whakapā mai ki tō mātou rōpū tautoko hangarau kia rere mārika ō pūnaha, kia anga whakamua i tō haerenga matihiko.",
      testimonials: [
        { quote: 'WhānauTech’s IT support transformed...', author: 'Tane, Whangārei' },
        { quote: 'Their team set up our network seamlessly...', author: 'Hine, Tauranga' },
        { quote: 'Thanks to WhānauTech, our systems are secure...', author: 'Rangi, Dunedin' },
      ]

    },
    digitalEducationPage: {
      title: "Digital Education",
      subtitle: "Empowering whānau and Māori communities with essential digital skills for today’s world.",
      ...
      testimonial: {
        quote: "Learning internet safety gave our tamariki confidence online. It’s made a huge difference for our whānau!",
        author: "Hana, Ōtautahi",
      },
    },
    cybersecurityPage: {
      title: "Cybersecurity Guidance",
      subtitle: "Protecting Māori businesses and whānau with expert cybersecurity advice to safeguard your digital assets.",
      ...
      whyTitle: "Why This Matters",
      whyText: "At WhānauTech, we prioritize the digital safety of tangata whenua, offering cybersecurity guidance rooted in tikanga Māori to protect your data and taonga while fostering trust and resilience.",
      howTitle: "How It Works",
      howSteps: [
        { icon: "📞", text: "Book a free initial kōrero" },
      ...
      readyTitle: "Ready to Get Started?",
      readyText: "Contact our cybersecurity team to secure your digital assets and start your journey to a safer online presence.",
      testimonialsTitle: "What Our Whānau Say",
      testimonials: [
        { quote: "WhānauTech’s cybersecurity audit protected our business from threats. Ka rawe!", author: "Tia, Gisborne" },
        { quote: "Their training empowered our team to stay safe online. Highly recommend!", author: "Rawiri, Nelson" },
        { quote: "Thanks to WhānauTech, we have a robust plan to recover from cyber incidents!", author: "Kahu, Rotorua" }
      ]
    },

    customSoftware: {
      title: "Custom Software",
      subtitle: "We build software that fits your kaupapa — from websites to mobile apps — tailored to Māori values, business needs, and community impact.",
      ...
      whyTitle: "Why This Matters",
      whyText: "At WhānauTech, we create software that empowers tangata whenua, respects tikanga Māori, and supports your vision. Our solutions enhance community connection and drive meaningful impact for Māori businesses and whānau.",
      howTitle: "How It Works",
      howSteps: [
        { icon: "📞", text: "Book a free initial kōrero" },
      ...
      readyTitle: "Ready to Get Started?",
      readyText: "Contact our team to start building custom software that supports your kaupapa and drives impact.",
      testimonialsTitle: "What Our Whānau Say",
      testimonials: [
        {
          quote: "WhānauTech turned our marae’s idea into a beautiful, easy-to-use app.",
    ...
    cloudSolutions: {
      title: "Cloud Solutions",
      subtitle: "Enabling Māori businesses and whānau to work flexibly and securely from anywhere using modern cloud technology.",
      subtitleMi: "He whakaahei i ngā pakihi Māori me te whānau kia mahi ngāwari, haumaru hoki mai i ngā wāhi katoa mā te hangarau kapua hou.",
      whatWeOfferTitle: "What We Offer",
      whatWeOffer: [
      { icon: "☁️", text: "Whakanekehanga kapua me te whakarite" },
      { icon: "📧", text: "Otinga īmēra me te rokiroki (Google Workspace, Microsoft 365)" },
      { icon: "🤝", text: "Taputapu mahi tahi mamao" },
      { icon: "💾", text: "Pūrua raraunga me te whakaora" },
      { icon: "🧑‍🏫", text: "Whakangungu me te tautoko haere tonu" }
      ],
      whyTitle: "Why This Matters",
      whyText: "At WhānauTech, our cloud solutions provide agility, scalability, and security, empowering Māori enterprises and whānau to thrive in a connected world while respecting tikanga Māori and data sovereignty.",
      whyTextMi: "I WhānauTech, ka whakarato ā mātou otinga kapua i te ngāwari, te tauine, me te haumarutanga, e whakakaha ana i ngā hinonga Māori me te whānau kia angitū i te ao hono, me te whakaute i te tikanga Māori me te mana motuhake raraunga.",
      howTitle: "How It Works",
      howSteps: [
        { icon: "📞", text: "Book a free initial kōrero" },
      ...
      readyTitle: "Ready to Get Started?",
      readyText: "Contact our cloud team to unlock flexible, secure solutions for your Māori business or whānau.",
      readyTextMi: "Whakapā mai ki tō mātou rōpū kapua ki te whakawātea i ngā otinga ngāwari, haumaru mō tō pakihi Māori, whānau rānei.",
      testimonialsTitle: 'What Our Whānau Say',
    testimonials: [
      {
        quote:
  ...
  mi: {
      ...
      items: [
        {
          ...
          description: 'Ngā tohutohu āta whakarite hei āwhina i ngā pakihi Māori ki te whakamahi hangarau mō te tipu.',
        },
        {
          title: 'Mātauranga Matihiko',
          description: 'Ngā awheawhe me ngā whakangungu hei whakawhanake i ngā pūkenga hangarau i roto i ō mātou hapori.',
        },
        {
          title: 'Tautoko IT',
        ...
        },
        {
          ...
          description: 'Te tiaki i ngā raraunga Māori mā ngā rautaki haumarutanga hou.',
        },
        {
          title: 'Rongoā Kapua',
          description: 'Te whakarite i ngā taiao mahi māmā mā ngā taputapu kapua.',
        },
        {
          title: 'Papatono Ritenga',
          description: 'Hangaia ngā taputapu ritenga e hāngai ana ki tō kaupapa.',
        },
      ],
    },
    advisors: {
    ...
    testimonials: [
      {
        quote: "I ārahi a WhānauTech i tō mātou marae ki te hurihanga matihiko me te ngākau aroha me te mārama.",
        name: "Aroha Ngatai",
        role: "Kaiārahi Hapori"
      },
      {
        quote: "Nā ngā awheawhe i whakapiki te māia o tō mātou kapa ki te whakamahi i ngā taputapu hangarau hou.",
        name: "Wiremu Rangi",
        role: "Kairuruku Hangarau"
      },
      {
        quote: "Kāore au i whakaaro ka taea te hono o te hangarau ki te ahurea i tēnei āhua whakamana.",
        name: "Hine Te Whaiti",
    ...
    chatbot: {
      ...
      greeting: 'Kia ora! Me pēhea ahau e āwhina ai i a koe ki WhānauTech i tēnei rā?',
    ...
    techConsultationPage: {
      title: 'Tohutohu Hangarau',
      subtitle: 'He tohutohu hangarau kua whakaritea hei āwhina i tō whānau, pakihi Māori hoki, kia angitū i te ao matihiko.',
      ...
      steps: [
        '📞 Tono he kōrero tuatahi kore utu',
        '📝 Tohaina ō whāinga, wero rānei',
        '🎯 Ka whiwhi koe i tētahi mahere kua whakaritea',
      ],
      ...
      testimonialQuote: '“I āwhina a WhānauTech i a mātou ki te kawe i tā mātou pakihi kai iti ki te ipurangi. Inaianei, he tokomaha kē atu ngā tāngata ka tae mai!”',
      testimonialAuthor: '– Aroha, Kirikiriroa',
      servicesList: [
        '💡 Ngā rautaki hangarau kua whakaritea',
        '🌐 Āwhina mō te paetukutuku me te ao matihiko',
        '📱 Tūtohutanga taupānga me ngā pūmanawa',
        '🔧 Whirihoranga pūnaha me ngā taputapu matihiko',
        '🧠 Āwhina whakakaha pūkenga',
      ]
    },
    itSupport: {
      title: "Tautoko Hangarau",
      subtitle: "He tautoko hangarau pono, whakahoahoa hoki, kua whakaritea hei āwhina i ngā pakihi Māori me te whānau kia rere mārika ō rātou pūnaha.",
      subtitleMaori: "He tautoko hangarau pono, whakahoahoa hoki, kua whakaritea hei āwhina i ngā pakihi Māori me te whānau kia rere mārika ō rātou pūnaha.",
      supportServicesTitle: "Ā Mātou Ratonga Tautoko",
      supportServices: [
        { icon: "💻", text: "Whakatika i ngā raruraru taputapu me te pūmanawa" },
        { icon: "🔧", text: "Whakaurunga me te whakarite taputapu me ngā whatunga" },
      ...
      whyTitle: "He Aha Tēnei e Hirahira Ai",
      whyText: "I WhānauTech, e whakapono ana mātou me whai hua te hangarau ki te whakakaha i te tangata whenua. E ū ana ā mātou tautoko ki te tikanga Māori, kia pono ō pūnaha kia tūhono ai koe ki tō kaupapa.",
      howTitle: "Me Pēhea te Mahi",
      howSteps: [
        { icon: "📞", text: "Book a free initial kōrero"},
        { icon: "📝", text: "Share your technical issues or goals" },
      ...
      readyTitle: "Kua Reri Koe?",
      readyText: "Whakapā mai ki tō mātou rōpū tautoko hangarau kia rere mārika ō pūnaha, kia anga whakamua i tō haerenga matihiko.",
      testimonials: [
        { quote: 'I āwhina te tautoko a WhānauTech...', author: 'Tane, Whangārei' },
        { quote: 'I whakatakotohia tō mātou whatunga...', author: 'Hine, Tauranga' },
    ...
    digitalEducationPage:{
      title: "Mātauranga Matihiko",
      subtitle: "Hei whakakaha i te whānau me te iwi Māori mā te mātauranga matihiko.",
      ...
      testimonial: {
        quote: "I whakawhiwhia aku tamariki ki te māia ipurangi mā te ako i te haumarutanga ipurangi. He nui te painga ki tō mātou whānau!",
        author: "Hana, Ōtautahi",
     },
    },
    cybersecurityPage: {
      title: "Arataki Haumarutanga Ipurangi",
      subtitle: "He tiaki i ngā pakihi Māori me te whānau me ngā tohutohu haumarutanga ipurangi hei tiaki i ō rawa matihiko.",
      ...
      whyTitle: "He Aha Tēnei e Hirahira Ai",
      whyText: "I WhānauTech, ka whakanui mātou i te haumarutanga matihiko o te tangata whenua, me ngā arataki haumarutanga e pūtake ana ki te tikanga Māori hei tiaki i ō raraunga me ō taonga, me te whakapakari i te whakawhirinaki me te pakari.",
      howTitle: "Me Pēhea te Mahi",
      howSteps: [
        { icon: "📞", text: "Tono he kōrero tuatahi kore utu" },
        { icon: "📝", text: "Tohaina ō māharahara haumarutanga, whāinga rānei" },
        { icon: "🎯", text: "Ka whiwhi koe i tētahi mahere haumarutanga kua whakaritea" },
      ],
      readyTitle: "Kua Reri Koe?",
      readyText: "Whakapā mai ki tō mātou rōpū haumarutanga ki te tiaki i ō rawa matihiko me te tīmata i tō haerenga ki te ao ipurangi haumaru.",
      testimonialsTitle: "Ngā Kōrero a te Iwi",
      testimonials: [
        { quote: "I ārai te arotake haumarutanga a WhānauTech i tō mātou pakihi i ngā mōrearea. Ka rawe!", author: "Tia, Tūranga-nui-a-Kiwa" },
        { quote: "Nā tā rātou whakangungu i āhei ai mātou ki te noho haumaru ā-ipurangi. Ka tūtohu mātou!", author: "Rawiri, Whakatū" },
        { quote: "Nā WhānauTech, kei a mātou he mahere kaha mō ngā tukinga ipurangi!", author: "Kahu, Rotorua" }
      ]
    },
    ...
    customSoftware: {
      ...
      subtitle: "Ka hanga mātou i ngā pūmanawa e hāngai ana ki tō kaupapa — mai i ngā paetukutuku ki ngā taupānga pūkoro — kua whakaritea ki ngā uara Māori, ngā hiahia pakihi, me te pānga hapori.",
      ...
      whyTitle: "He Aha Tēnei e Hirahira Ai",
      whyText: "I WhānauTech, ka hanga mātou i ngā pūmanawa e whakakaha ana i te tangata whenua, e whakaute ana i te tikanga Māori, e tautoko ana i tō tirohanga. Ka whakapakari ā mātou otinga i te hononga hapori me te whai pānga nui ki ngā pakihi Māori me te whānau.",
      howTitle: "Me Pēhea te Mahi",
      howSteps: [
        { icon: "📞", text: "Tono he kōrero tuatahi kore utu" },
        { icon: "📝", text: "Tohaina ō hiahia pūmanawa, whakaaro rānei" },
        { icon: "🎯", text: "Ka whiwhi koe i tētahi otinga pūmanawa kua whakaritea" },
      ],
      readyTitle: "Kua Reri Koe?",
      readyText: "Whakapā mai ki tō mātou rōpū ki te tīmata i te hanga pūmanawa whakarite e tautoko ana i tō kaupapa me te whai pānga.",
      testimonialsTitle: "Ngā Kōrero a te Iwi",
      testimonials: [
        {
          quote: "I hurahia e WhānauTech te whakaaro o tō mātou marae hei taupānga ātaahua, ngāwari ki te whakamahi.",
          author: "Mereana, Ngāti Porou",
        },
        {
          quote: "Nā tā rātou paetukutuku whakarite i tae atu ā mātou pakihi ki ngā kiritaki hōu. Ka tūtohu nui!",
          author: "Tama, Tāmaki Makaurau",
        },
        {
          quote: "Ko te pūmanawa i hangaia e WhānauTech mō tō mātou papa hapori he mea whakarerekē kē!",
    ...
    cloudSolutions: {
      title: "Otinga Kapua",
      subtitle: "He whakaahei i ngā pakihi Māori me te whānau kia mahi ngāwari, haumaru hoki mai i ngā wāhi katoa mā te hangarau kapua hou.",
      subtitleMi: "He whakaahei i ngā pakihi Māori me te whānau kia mahi ngāwari, haumaru hoki mai i ngā wāhi katoa mā te hangarau kapua hou.",
      ...
      whyTitle: "He Aha Tēnei e Hirahira Ai",
      whyText: "I WhānauTech, ka whakarato ā mātou otinga kapua i te ngāwari, te tauine, me te haumarutanga, e whakakaha ana i ngā hinonga Māori me te whānau kia angitū i te ao hono, me te whakaute i te tikanga Māori me te mana motuhake raraunga.",
      whyTextMi: "I WhānauTech, ka whakarato ā mātou otinga kapua i te ngāwari, te tauine, me te haumarutanga, e whakakaha ana i ngā hinonga Māori me te whānau kia angitū i te ao hono, me te whakaute i te tikanga Māori me te mana motuhake raraunga.",
      howTitle: "Me Pēhea te Mahi",
      howSteps: [
        { icon: "📞", text: "Tono he kōrero tuatahi kore utu" },
        { icon: "📝", text: "Tohaina ō hiahia kapua, whāinga rānei" },
        { icon: "🎯", text: "Ka whiwhi koe i tētahi otinga kapua kua whakaritea" }
      ],
      readyTitle: "Kua Reri Koe?",
      readyText: "Whakapā mai ki tō mātou rōpū kapua ki te whakawātea i ngā otinga ngāwari, haumaru mō tō pakihi Māori, whānau rānei.",
      readyTextMi: "Whakapā mai ki tō mātou rōpū kapua ki te whakawātea i ngā otinga ngāwari, haumaru mō tō pakihi Māori, whānau rānei.",
      testimonialsTitle: 'Ngā Kōrero a te Iwi',
      testimonials: [
        {
