...
const CloudSolutions = ({ selectedLanguage }) => {
	const t =
		translations[selectedLanguage]?.cloudSolutions ||
		translations.en.cloudSolutions;
		...
		<div className="tech-consultation-page min-vh-100">
			...
			<main className="container py-5">
				<section className="services-section mb-5">
					<h2 className="h3 text-center mb-4">{t.whatWeOfferTitle}</h2>
