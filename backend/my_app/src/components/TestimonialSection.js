...
function TestimonialSection() {
  ...
  return (
    <section className="testimonial-section py-5" style={{ backgroundColor: '#e6f2ff' }}>
      <div className="container">
        <h2 className="mb-4 text-start" data-aos="fade-right" style={{ color: '#004466' }}>
        ...
        <div className="row">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div
                className="card h-100 shadow-sm testimonial-card"
                style={{
                  borderLeft: '5px solid #00664f',
              ...
              >
                <div className="card-body text-center">
                  ...
                  {phases[index] >= 1 && (
                    <blockquote className={`blockquote mb-3 ${phases[index] === 1 ? 'fade-in' : 'combined-visible'}`} style={{ fontSize: '1.05rem', lineHeight: '1.6' }}>
