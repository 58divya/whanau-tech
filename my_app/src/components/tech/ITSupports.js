...
const ITSupport = ({ selectedLanguage }) => {
  const t = translations[selectedLanguage]?.itSupport || translations.en.itSupport;
    ...
    <div className="tech-consultation-page min-vh-100">
      ...
      <main className="container py-5">
        <section className="services-section mb-5">
          <h2 className="h3 text-center mb-4">{t.supportServicesTitle}</h2>
          <div className="row row-cols-1 row-cols-md-2 g-4">
            {t.supportServices.map((service, index) => (
          ...
          <div id="itSupportCarousel" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              {t.testimonials.map((testimonial, index) => (
                ...
                >
                  <blockquote className="p-4 rounded shadow text-center">
